...
export const SERVICE_CAPABILITIES: Record<ServiceKey, readonly CapabilityKey[]> = {
  ...
  PERSONAL_PROTECTION: ["CLOSE_PROTECTION", "DE_ESCALATION", "SITUATIONAL_AWARENESS"],
  PROTECTOR_DRIVER: ["PROFESSIONAL_DRIVING", "DEFENSIVE_DRIVING", "DE_ESCALATION"],
  SPECIALIST_SUPPORT: ["ADVANCED_MEDICAL", "CYBERSECURITY_LITERACY", "VULNERABLE_PERSON_SUPPORT"],
};
